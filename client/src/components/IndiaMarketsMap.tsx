  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 70% 55% at 50% 48%, rgba(46,125,50,0.13) 0%, transparent 80%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative w-full h-84 sm:h-96 my-2 flex items-center justify-center select-none overflow-hidden">
        <svg
          ...
          className="w-full h-full max-h-[380px] transition-transform duration-300"
        >
          <defs>
            ...
            {indiaMapData.locations.map((loc) => {
              ...
              return (
                <path
                  ...
                  className="transition-all duration-300 hover:fill-[rgba(255,255,255,0.12)] cursor-pointer"
                  onClick={() => {
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  fill={isSelected ? "#4ADE80" : pin.isMega ? "#E8A238" : "#6FBF73"}
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-[#6FBF73]"></span>
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1 min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="text-[9px] font-mono font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-[#2E7D32]/30 text-[#4ADE80] border border-[#2E7D32]/40">
                {activePin.type}
              </span>
            ...
            <div className="flex items-center gap-2 pt-0.5 text-[11px]">
              ...
              <span className="text-white/45 font-mono text-[10px]">
          ...
          <div className="text-right shrink-0 space-y-1">
            ...
            <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded font-mono inline-block ${
              activePin.change.startsWith('+') ? 'text-[#4ADE80] bg-[#4ADE80]/15' : 'text-rose-400 bg-rose-500/15'
            }`}>
